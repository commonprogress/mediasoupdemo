    ...
    public void setProps(MeProps props, final RoomClient roomClient, RoomStore roomStore) {
        ...
        props.setOnPropsLiveDataChange(ediasProps -> {
            if (!isReleaseView()) {
                ...
                // set view model.
                setPeerViewProps(meProps, null != roomClient ? roomClient.isConnected() : false);
                setMeCameraFace(meProps, null != roomClient ? roomClient.isConnected() : false);
                // set view model.
                setMeProps(meProps, null != roomClient ? roomClient.isConnected() : false);
            }
        });
...
//        videoRenderer.setMirror(isFrontCamera);
    ...
    private void setPeerViewProps(MeProps props, boolean isConnected) {
        ...
        LogUtils.i(TAG, "setPeerViewProps,mediasoup null == videoTrack:" + (null == videoTrack) + ",step:" + step + ", isConnected:" + isConnected + ", isAddVideoTrack:" + isAddVideoTrack + ",camState:" + camState + ", null == me:" + (null == me) + ", null == curMe:" + (null == curMe) + ",null == props:" + (null == props) + ",peerState:" + peerState);
        this.curMe = me;
