...
public class PeerConnectionTest {
  ...
  public void testCompleteSession() throws Exception {
    ...
    assertEquals(SignalingState.STABLE, offeringPC.signalingState());
    assertTrue(sdpLatch.await());
    ...
    assertEquals(SignalingState.STABLE, offeringPC.signalingState());
    assertEquals(SignalingState.STABLE, answeringPC.signalingState());
  ...
  public void testSurfaceIceCandidatesWhenIceTransportTypeChanged() throws Exception {
    ...
    rtcConfig.iceTransportsType = IceTransportsType.NONE;
